...
public class UnibillDemo : MonoBehaviour {
	...
	void OnGUI () {
        ...
        GUI.Label(new Rect(0, start - 10, 500, 50), "Purchasable Item", listStyle);

        // Draw the purchase quantities for our various purchasables.
        start = (int) (Screen.height - Screen.width / 6.0f) - 50;
        foreach (PurchasableItem item in items) {
